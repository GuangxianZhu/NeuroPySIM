...
MAX_TRANSISTOR_HEIGHT_FINFET = 34.0
MAX_TRANSISTOR_HEIGHT = 28.0

# standard cell height trend - updated
...
MIN_GAP_BET_SAME_TYPE_DIFFS = 1.6  # not used

MIN_GAP_BET_P_AND_N_DIFFS = 3.5
MIN_POLY_EXT_DIFF = 1.0  # Minimum poly extension beyond diffusion region
MIN_GAP_BET_FIELD_POLY = 1.6  # Field poly means the poly above the field oxide (outside the active region)

# PN separation, region outside fin (half of the inter-spacing between outermost fins in adjacent standard cells) - updated
# OUTER_HEIGHT_REGION = Cell height - MIN_GAP_BET_P_AND_N_DIFFS (PN gap) - Fin region
...
# updated comment - needed for senseamp
...
HEIGHT_WIDTH_RATIO_LIMIT = 5.0

RATIO_READ_THRESHOLD_VS_VOLTAGE = 0.2

ROW_MODE = 0  # Connect to rows
COL_MODE = 1  # Connect to columns
